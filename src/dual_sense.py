...
if __name__ == "__main__":
    ...
    print("Dummy: ", run_model(data_multift, DummyClassifier(random_state=SEED)))
    print("LogReg: ", run_model(data_multift, LogisticRegression(random_state=SEED)))
    print("LGBM: ", run_model(data_multift, LGBMClassifier(random_state=SEED)))
